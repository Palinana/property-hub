    ...
    return (
        <div className={`${styles.pages} ${styles.container}`}>
            ...
            <div className="container-fluid">
                <div className="row d-flex align-items-center mb-6 gx-5" id={styles.heroSection}>
                ...
                {/* Footer */}
                <div className="row row-cols-1 row-cols-sm-3 row-cols-md-6 py-5 mt-5 border-top" id={styles.footerSection}>
